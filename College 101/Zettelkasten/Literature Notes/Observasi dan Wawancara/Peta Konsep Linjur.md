...
flowchart TD
    ...
    MAG --> M3["Pemetaan zona kesulitan\npersonal yang akurat"]
...
```mermaid
flowchart LR
    A["Mahasiswa IPS\nmasuk Saintek"] --> B["Kesenjangan\nPengetahuan Awal"]
    B --> C{"Respons\nMahasiswa"}

    C -->|"Strategi adaptif\n+ dukungan sosial\n+ motivasi eksternal"| D["Efikasi Diri\nMENINGKAT"]
    C -->|"Gengsi + overload\n+ AI tanpa pemahaman"| E["Efikasi Diri\nMENURUN"]

    D --> F["Percaya diri\ndi bidang tertentu\n(praktikum, coding, lab)"]
    E --> G["Menghindari\n(bolos, contek,\nserahkan ke AI)"]

    F -->|"belum tergeneralisasi"| H["Efikasi Spesifik\n(bukan menyeluruh)"]
    G -->|"titik kritis\n(nilai jelek, rasa\nsalah jurusan)"| I["Titik Balik:\nKeputusan untuk\nbertahan & usaha lebih"]
    I --> D
```
